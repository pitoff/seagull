				...
				<div class="container" style="margin-top: 100px;">
                    <div class="row">
                        <div class="col col-lg-12">
                        	<div class="col-lg-6 col-md-6 col-sm-6"><h1 style="text-align: center; color: #fff;">Shipment Details</h1></div>
                            <form role="form" method="POST" action="<?php echo URLROOT;?>/user/shipment">
